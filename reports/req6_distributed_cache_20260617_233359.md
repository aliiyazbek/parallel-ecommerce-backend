...
| Cache misses | 0 | 2 |
| Hit ratio | 0.0% | 99.8% |
| Read latency p50 (ms) | 17.36 | 0.12 |
| Read latency p95 (ms) | 32.54 | 0.43 |
| Wall time (ms) | 1027 | 594 |

**Verdict:** the cache eliminated **998** of **1000** database queries (**99.8%** fewer), reaching a **99.8%** hit ratio, and cut total wall time by **1.7x**. After the first miss, popular-product reads no longer touch the database at all — exactly the goal of Requirement 6.
