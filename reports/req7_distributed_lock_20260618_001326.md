...
- **BEFORE critical-section latency (AOP @measure):** p50 102.17 ms / p95 119.23 ms / max 147.08 ms over 50 calls.
- **AFTER critical-section latency (AOP @measure):** p50 1313.52 ms / p95 1483.17 ms / max 1530.27 ms over 50 calls.
