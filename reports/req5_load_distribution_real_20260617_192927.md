...
|-------|---------:|-------:|----------:|---------:|------------------------------:|
| **BEFORE - one instance** | 300 | 0 | 856 | 43.5 | 0 |
| **AFTER - 3 instances (round_robin)** | 300 | 0 | 500 | 49.3 | 0 |
...
|----------|-----------------:|----------:|---------:|-------:|
| `round_robin` ✅ | 0 | 500 | 49.3 | 0 |
| `random` | 12 | 435 | 39.4 | 0 |
| `least_connections` | 49 | 476 | 48.5 | 0 |
