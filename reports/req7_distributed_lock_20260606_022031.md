...
- **BEFORE critical-section latency (AOP @measure):** p50 256.2 ms / p95 1306.62 ms / max 1430.41 ms over 50 calls.
- **AFTER critical-section latency (AOP @measure):** p50 678.75 ms / p95 716.26 ms / max 718.62 ms over 50 calls.
