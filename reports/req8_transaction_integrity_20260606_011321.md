...
## Concurrent: atomicity under 10 simultaneous failing purchases

| Mode | Threads | Money lost | Stock lost | Verdict |
|------|--------:|-----------:|-----------:|---------|
| **NON-ATOMIC** | 10 | 100.00 | 1 | DATA CORRUPTED |
| **ATOMIC** | 10 | 0.00 | 0 | OK — fully rolled back |
