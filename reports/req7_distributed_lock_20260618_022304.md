...
- **BEFORE critical-section latency (AOP @measure):** p50 114.0 ms / p95 231.54 ms / max 304.95 ms over 50 calls.
- **AFTER critical-section latency (AOP @measure):** p50 1244.21 ms / p95 1439.65 ms / max 1459.27 ms over 50 calls.
