...
|-------|---------:|-------:|----------:|---------:|------------------------------:|
| **BEFORE - one instance** | 300 | 0 | 929 | 41.8 | 0 |
| **AFTER - 3 instances (round_robin)** | 300 | 0 | 475 | 47.7 | 0 |
...
|----------|-----------------:|----------:|---------:|-------:|
| `round_robin` ✅ | 0 | 475 | 47.7 | 0 |
| `random` | 18 | 465 | 45.5 | 0 |
| `least_connections` | 12 | 440 | 40.7 | 0 |
