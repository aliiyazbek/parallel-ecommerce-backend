...
| Cache misses | 0 | 20 |
| Hit ratio | 0.0% | 98.0% |
| Read latency p50 (ms) | 28.26 | 0.01 |
| Read latency p95 (ms) | 44.41 | 0.01 |
| Wall time (ms) | 1491 | 69 |

**Verdict:** the cache eliminated **980** of **1000** database queries (**98.0%** fewer), reaching a **98.0%** hit ratio, and cut total wall time by **21.6x**. After the first miss, popular-product reads no longer touch the database at all — exactly the goal of Requirement 6.
