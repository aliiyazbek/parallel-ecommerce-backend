...
**Generated:** 2026-06-06T01:16:03  
**Workload:** 200 requests at a steady arrival rate
...
|-------|--------:|---------------:|--------:|---------:|----------:|---------:|
| **BEFORE - single node** | 1 | 6 | 90 | 110 | 820 | 51 |
| **AFTER - 4 nodes (round_robin)** | 4 | 24 | 200 | 0 | 807 | 51 |

**Verdict:** scaling from 1 node to 4 nodes behind the load balancer cut rejected requests from **110** to **0** (110 fewer). A single node tops out at its worker limit and drops the overflow; spreading the same traffic across nodes removes that single-instance bottleneck.
