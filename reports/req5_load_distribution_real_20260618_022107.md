...
|-------|---------:|-------:|----------:|---------:|------------------------------:|
| **BEFORE - one instance** | 300 | 0 | 865 | 41.3 | 0 |
| **AFTER - 3 instances (round_robin)** | 300 | 0 | 497 | 46.2 | 0 |
...
|----------|-----------------:|----------:|---------:|-------:|
| `round_robin` ✅ | 0 | 497 | 46.2 | 0 |
| `random` | 10 | 479 | 46.8 | 0 |
| `least_connections` | 14 | 563 | 54.6 | 0 |
