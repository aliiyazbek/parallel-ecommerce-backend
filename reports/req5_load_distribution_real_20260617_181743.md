...
|-------|---------:|-------:|----------:|---------:|------------------------------:|
| **BEFORE - one instance** | 300 | 0 | 649 | 40.5 | 0 |
| **AFTER - 3 instances (round_robin)** | 300 | 0 | 477 | 42.3 | 0 |
...
|----------|-----------------:|----------:|---------:|-------:|
| `round_robin` ✅ | 0 | 477 | 42.3 | 0 |
| `random` | 8 | 463 | 45.6 | 0 |
| `least_connections` | 12 | 438 | 42.0 | 0 |
