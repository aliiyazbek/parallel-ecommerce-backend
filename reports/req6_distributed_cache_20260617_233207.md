...
| Cache misses | 0 | 1 |
| Hit ratio | 0.0% | 99.9% |
| Read latency p50 (ms) | 25.25 | 0.12 |
| Read latency p95 (ms) | 40.19 | 0.42 |
| Wall time (ms) | 1352 | 552 |

**Verdict:** the cache eliminated **999** of **1000** database queries (**99.9%** fewer), reaching a **99.9%** hit ratio, and cut total wall time by **2.4x**. After the first miss, popular-product reads no longer touch the database at all — exactly the goal of Requirement 6.
