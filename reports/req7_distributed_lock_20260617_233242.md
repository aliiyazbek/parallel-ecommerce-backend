...
- **BEFORE critical-section latency (AOP @measure):** p50 111.98 ms / p95 125.22 ms / max 125.42 ms over 50 calls.
- **AFTER critical-section latency (AOP @measure):** p50 1283.54 ms / p95 1570.1 ms / max 1614.67 ms over 50 calls.
