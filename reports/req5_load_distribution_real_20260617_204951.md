...
|-------|---------:|-------:|----------:|---------:|------------------------------:|
| **BEFORE - one instance** | 300 | 0 | 481 | 39.6 | 0 |
| **AFTER - 3 instances (round_robin)** | 300 | 0 | 505 | 48.9 | 0 |
...
|----------|-----------------:|----------:|---------:|-------:|
| `round_robin` ✅ | 0 | 505 | 48.9 | 0 |
| `random` | 9 | 477 | 45.4 | 0 |
| `least_connections` | 14 | 442 | 39.9 | 0 |
