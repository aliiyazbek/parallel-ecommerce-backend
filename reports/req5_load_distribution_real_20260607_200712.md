...
|-------|---------:|-------:|----------:|---------:|------------------------------:|
| **BEFORE - one instance** | 300 | 0 | 437 | 39.1 | 0 |
| **AFTER - 3 instances (round_robin)** | 300 | 0 | 434 | 40.5 | 0 |
...
|----------|-----------------:|----------:|---------:|-------:|
| `round_robin` ✅ | 0 | 434 | 40.5 | 0 |
| `random` | 13 | 465 | 45.7 | 0 |
| `least_connections` | 18 | 418 | 40.0 | 0 |
